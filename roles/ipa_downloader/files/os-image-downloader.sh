#!/bin/bash
# =============================================================================
# Ubuntu LTS Image Downloader
# =============================================================================
# Downloads Ubuntu LTS cloud image and checksum for provisioning.
# =============================================================================
...
setup_directory() {
    if [ ! -d "$UBUNTU_LTS_IMAGE_DIR" ]; then
...
main() {
    log "Starting Ubuntu LTS image downloader..."

    if ! is_true "$UBUNTU_LTS_IMAGE_ENABLED"; then
        log "Ubuntu LTS image mirroring is disabled; nothing to download"
        return 0
    fi
    ...
    verify_downloads
    log "Ubuntu LTS image downloader completed"
}
